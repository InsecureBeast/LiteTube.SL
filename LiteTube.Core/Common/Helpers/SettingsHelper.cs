...
namespace LiteTube.Core.Common.Helpers
{
    public static class SettingsHelper
    {
        ...
        public static string SaveRegion(string regionName)
        {
        ...
        public static void SaveQuality(string qualityName)
        {
        ...
        public static void SaveUserRefreshToken(string refreshToken)
        {
        ...
        public static void SaveUserAccessToken(string accessToken)
        {
            ApplicationData.Current.RoamingSettings.Values["AccessToken"] = accessToken;
        }

        public static void SaveIsRevokedAccessToken(bool isRevoked)
        {
            ApplicationData.Current.RoamingSettings.Values["IsRevokedAccessToken"] = isRevoked;
        }

        public static bool GetIsRevokedAccessToken()
        {
            var isRevoked = false;
        ...
        public static bool IsContainsAuthorizationData()
        {
        ...
        public static void SaveTheme(ApplicationTheme theme)
        {
