...
// Type: SM.Media.Utility.RandomGenerators.Well512
...
namespace SM.Media.Utility.RandomGenerators
{
  public class Well512 : IRandomGenerator<uint>, IRandomGenerator
  {
    ...
    public uint Next()
    {
      uint num1 = this._state[(IntPtr) this._index];
      uint num2 = this._state[(IntPtr) (uint) ((int) this._index + 13 & 15)];
      uint num3 = (uint) ((int) num1 ^ (int) num2 ^ (int) num1 << 16 ^ (int) num2 << 15);
      uint num4 = this._state[(IntPtr) (uint) ((int) this._index + 9 & 15)];
      uint num5 = num4 ^ num4 >> 11;
      uint num6 = this._state[(IntPtr) this._index] = num3 ^ num5;
      uint num7 = num6 ^ (uint) ((int) num6 << 5 & -633066204);
      this._index = (uint) ((int) this._index + 15 & 15);
      uint num8 = this._state[(IntPtr) this._index];
      this._state[(IntPtr) this._index] = (uint) ((int) num8 ^ (int) num3 ^ (int) num7 ^ (int) num8 << 2 ^ (int) num3 << 18 ^ (int) num5 << 28);
      return this._state[(IntPtr) this._index];
    }
