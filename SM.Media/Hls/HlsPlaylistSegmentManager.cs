...
// Type: SM.Media.Hls.HlsPlaylistSegmentManager
...
label_16:;
    ...
    private bool UpdatePlaylist()
    {
      ...
      Debug.WriteLine("HlsPlaylistSegmentManager.UpdatePlaylist: playlist {0} loaded with {1} entries. index: {2} dynamic: {3} expires: {4} ({5})", (object) this._programStream, (object) this._segments.Length, (object) this._startSegmentIndex, (object) (bool) (isDynamicPlaylist ? 1 : 0), (object) (isDynamicPlaylist ? TimeSpan.FromMilliseconds((double) (this._segmentsExpiration - Environment.TickCount)) : TimeSpan.Zero), (object) DateTimeOffset.Now);
      return true;
    }
