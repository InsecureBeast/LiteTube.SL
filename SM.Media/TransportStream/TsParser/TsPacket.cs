...
// Type: SM.Media.TransportStream.TsParser.TsPacket
    ...
    public override string ToString()
    {
      ...
      if ((this._adaptationFieldControl & 2) != 0 && this._adaptationLength > 0)
      {
        ...
        if (0 != ((int) this._adaptationFlags & 16))
        {
          ...
          __Boxed<TimeSpan> local = (ValueType) TimeSpan.FromTicks((long) (pcr.HasValue ? new double?((double) pcr.GetValueOrDefault() * (10.0 / 27.0)) : new double?()).Value);
