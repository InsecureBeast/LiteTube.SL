...
label_9:
      ...
      if (verbose)
        Debug.WriteLine("Configuration AAC layer {0} profile \"{1}\" channels {2} sampling {3}kHz length {4} CRC {5}", (object) this.Layer, (object) this.Name, (object) this.ChannelConfig, (object) ((double) this.SamplingFrequency / 1000.0), (object) this.FrameLength, (object) (bool) (this.CrcFlag));
      return true;
    }
