...
namespace LiteTube.ViewModels.Nodes
{
    public class CommentNodeViewModel : NodeViewModelBase
    {
        ...
        public CommentNodeViewModel(IComment comment, Func<IDataSource> getDatasource, IConnectionListener connectionListener, IContextMenuProvider menuProvider = null) : base(getDatasource(), menuProvider)
        {
